        ...
        {!fac ? (
          ...
          <div
            style={{
              ...
              boxShadow: "var(--shadow-sm)",
              border: `1px solid ${
                fac.statut === "impayée" ? "#fecaca" : "var(--white-3)"
              }`,
            }}
          >
            <div
            ...
            <div style={{ padding: "18px 22px" }}>
              ...
              >
                {[
                  {
                    label: "Plan",
                    val: fac.plan.charAt(0).toUpperCase() + fac.plan.slice(1),
                  },
                  {
                    label: "Montant HT",
                    val: `${(fac.montant / 1.2).toFixed(0)}€`,
                  },
                  {
                    label: "TVA 20%",
                    val: `${(fac.montant - fac.montant / 1.2).toFixed(0)}€`,
                  },
                  { label: "Total TTC", val: `${fac.montant}€`, bold: true },
                  { label: "Méthode", val: fac.methode },
                  { label: "Référence", val: fac.reference || "—" },
                ].map((r) => (
                  <div
                    key={r.label}
                    style={{
                  ...
                  >
                    ...
                    <div
                      style={{
                        fontSize: r.bold ? "16px" : "13px",
                        fontWeight: r.bold ? "700" : "500",
                        color: r.bold ? "var(--gold-dark)" : "var(--noir)",
                      }}
                    >
                      {r.val}
                    </div>
              ...
              <span
                style={{
                  ...
                  padding: "5px 14px",
                  borderRadius: "20px",
                  background: STATUT_CFG[fac.statut].bg,
                  color: STATUT_CFG[fac.statut].color,
                  display: "inline-flex",
                  alignItems: "center",
                  gap: "6px",
                }}
              >
                <span
                  style={{
                    ...
                    height: 6,
                    borderRadius: "50%",
                    background: STATUT_CFG[fac.statut].dot,
                  }}
                />
                {STATUT_CFG[fac.statut].label}
              </span>
              ...
              <button
                onClick={() => {
                  toast.success(`Facture ${fac.id} téléchargée`);
                }}
                style={{
                  marginTop: "14px",
                  width: "100%",
