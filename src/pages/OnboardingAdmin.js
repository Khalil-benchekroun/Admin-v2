...
const DOSSIERS_DATA = [
  {
    ...
    historique: [
      {
        action: "Inscription via lien INV-012",
        par: "Rouje",
        heure: "10:05",
        date: "08/04/2026",
      },
      {
        action: "Dossier créé — validation en cours",
        par: "Système",
        heure: "10:05",
        date: "08/04/2026",
      },
      {
        action: "Infos légales vérifiées ✓",
        par: "Khalil B.",
        heure: "14:30",
        date: "09/04/2026",
      },
  ...
  },
  {
    ...
    historique: [
      {
        action: "Inscription via lien INV-011",
        par: "Maison Kitsuné",
        heure: "09:20",
        date: "11/04/2026",
      },
      ...
      {
        action: "Dossier complet vérifié",
        par: "Khalil B.",
        heure: "11:00",
        date: "12/04/2026",
      },
  ...
  },
  {
    ...
    historique: [
      ...
      {
        action: "Dossier validé et boutique activée",
        par: "Khalil B.",
        heure: "16:00",
        date: "12/01/2026",
      },
...
export default function OnboardingAdmin() {
  ...
  const stats = {
    ...
    attenteSig: dossiers.filter((d) => d.statut === "en_attente_signature")
      .length,
        ...
        d.id === selected
          ? {
              ...
              historique: [
                ...d.historique,
                {
                  action: `${CHECKLIST_CFG[key].label} — ${
                    !d.checklist[key] ? "validé ✓" : "dévalidé"
                  }`,
                  par: "Khalil B.",
                  heure: now(),
                  date: today(),
        ...
        d.id === selected
          ? {
              ...
              historique: [
                ...d.historique,
                {
                  action: "Boutique activée sur la plateforme",
                  par: "Khalil B.",
                  heure: now(),
                  date: today(),
                },
        ...
        d.id === selected
          ? {
              ...
              historique: [
                ...d.historique,
                {
                  action: `Dossier refusé — ${refusMotif}`,
                  par: "Khalil B.",
                  heure: now(),
                  date: today(),
                },
  ...
  return (
    <div className="page" style={{ padding: "44px 52px" }}>
      <div style={{ marginBottom: "36px" }}>
        ...
        <p style={SUB}>
          Validation des dossiers partenaires et activation sur la plateforme
        </p>
      </div>
                  ...
                  >
                    <div
                      style={{
                        ...
                        background: done === total ? "#10B981" : "var(--gold)",
                        borderRadius: "4px",
                      }}
                    />
                  </div>
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  <span
                    style={{
                      ...
                      padding: "3px 10px",
                      borderRadius: "20px",
                      background: STATUT_CFG[dos.statut].bg,
                      color: STATUT_CFG[dos.statut].color,
                    }}
                  >
                    <span
                      style={{
                        ...
                        height: 6,
                        borderRadius: "50%",
                        background: STATUT_CFG[dos.statut].dot,
                  ...
                  <span
                    style={{
                      ...
                      borderRadius: "20px",
                      background: `rgba(${
                        PLAN_CFG[dos.plan].color === "#C9A96E"
                          ? "201,169,110"
                          : PLAN_CFG[dos.plan].color === "#3B82F6"
                          ? "59,130,246"
                          : "107,114,128"
                      },0.1)`,
                      color: PLAN_CFG[dos.plan].color,
                    }}
                  >
              ...
              {dos.statut !== "activé" && dos.statut !== "refusé" && (
                <div style={{ display: "flex", gap: "8px" }}>
                  ...
                  <button
                    ...
                    style={{
                      ...bStyle("gold"),
                      opacity: checklistComplete(dos.checklist) ? 1 : 0.5,
                    }}
                  >
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: "12px",
                        fontWeight: "600",
                        color: checklistComplete(dos.checklist)
                          ? "#2e8b57"
                          : "#b7770d",
                      }}
                    >
                      {Object.values(dos.checklist).filter(Boolean).length}/
                      {Object.keys(dos.checklist).length} éléments
                    </span>
                  </div>
                  <div
                    style={{
                    ...
                    {Object.entries(CHECKLIST_CFG).map(([key, cfg]) => (
                      <div
                        ...
                        style={{
                          ...
                          background: dos.checklist[key]
                            ? "#e8f5ee"
                            : "var(--gray-bg)",
                          border: `1px solid ${
                            dos.checklist[key] ? "#bbf7d0" : "var(--white-3)"
                          }`,
                          cursor:
                            dos.statut !== "activé" ? "pointer" : "default",
                          transition: "all 0.15s",
                        }}
                      >
                        <div
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                <div
                  style={{
                    ...
                    padding: "12px 16px",
                    fontSize: "13px",
                    color: dos.notes ? "var(--noir)" : "var(--gray-light)",
                    fontStyle: dos.notes ? "normal" : "italic",
                    whiteSpace: "pre-wrap",
                    lineHeight: 1.6,
          ...
          >
            ...
            >
              {[
                ...
                "Boutique non conforme aux critères LIVRR",
                "Zone géographique non couverte",
                "Activité non compatible avec la plateforme",
              ].map((m) => (
                <button
                  key={m}
            ...
            >
              ...
              <button onClick={refuserDossier} style={bStyle("error")}>
                Confirmer le refus
              </button>
            </div>
          </div>
