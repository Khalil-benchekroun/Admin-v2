    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "36px" }}>
          ...
          >
            Espace réservé à l'équipe interne LIVRR.
          </p>
        </div>
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            {ROLES_DEMO.map((r) => (
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background = `${r.color}20`)
                }
                onMouseLeave={(e) =>
        ...
        >
          ...
          >
            Accès restreint — Usage interne LIVRR uniquement
          </p>
        </div>
      </div>
      ...
      <div style={{ flex: 1, position: "relative", overflow: "hidden" }}>
        ...
        >
          ...
          >
            {[
              { value: "12", label: "Boutiques actives" },
              { value: "2 847", label: "Clients inscrits" },
              { value: "95 400 €", label: "CA ce mois" },
            ].map((s) => (
        ...
        <div
          style={{
            ...
            width: "1px",
            background:
              "linear-gradient(180deg, transparent, rgba(201,169,110,0.15), transparent)",
          }}
        />
      </div>
    </div>
